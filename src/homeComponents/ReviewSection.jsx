        ...
        <>
           <section className='w-full bg-[#CECEDE] py-16 px-5'>
                ...
                <div className='text-white flex flex-col md:flex-row px-8 md:px-36 gap-6 mt-8'>
                    ...
                    <div className='flex rounded-md py-0 md:py-8 basis-[50%]'>
                        <div className='basis-[50%]'><img className='w-full h-full' src={LindaJohnson} alt="First customer" /></div>
                        <div className='bg-[#003311] basis-[50%] rounded-r-md p-3 text-[0.8rem]'><p>"As a new business in the food industry, we struggled to find relaible supppliers. Konectar 
                    ...
                    <div className='flex rounded-md py-0 md:py-8 basis-[50%]'>
                        ...
                        <div className='bg-[#003311] basis-[50%] rounded-r-md p-3 text-[0.8rem]'><p>"Konectar has been an invaluable partner for our business. Thea ability to source local 
                ...
                <div className='text-white flex flex-col md:flex-row px-8 md:px-36 gap-6 mt-6 md:mt-0'>
                    ...
                    <div className='flex rounded-md py-0 md:py-8 basis-[50%]'>
                        ...
                        <div className='bg-[#003311] basis-[50%] rounded-r-md p-3 text-[0.8rem]'><p>"We've been using Konectar for over a year now, and it has transformed the way we handle our procurement. 
                    ...
                    <div className='flex rounded-md py-0 md:py-8 basis-[50%]'>
                        ...
                        <div className='bg-[#003311] basis-[50%] rounded-r-md p-3 text-[0.8rem]'><p>"Konectar has made sourcing fresh produce more accessible than ever. The user-friendly platform ensures we 
