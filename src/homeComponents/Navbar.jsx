...
const Navbar = () => {
  ...
  { label: "Blog", href: "blog" }, */}
    ...
    {mobileMenu && (
      <div className='lg:hidden w-full py-12 bg-white ease-in-out duration-500 flex flex-col border-solid border-[1px] border-[#4665] justify-center items-center fixed top-15'>
      <ul className=''>
