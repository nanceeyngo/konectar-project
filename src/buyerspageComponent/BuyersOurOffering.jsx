...
const BuyersOurOffering = () => {
    return (
        <>
         ...
         <h1 className='text-white text-center font-Manrope font-bold text-[2.5rem] leading-tight md:leading-snug'>Our offering</h1>
         ...
         <div className='flex flex-col md:flex-row gap-5 justify-center items-center mt-10'>
                <div className='bg-[#ffffff] px-4 py-4 rounded-lg basis-[30%]'>
                    ...
                    <h1 className='font-bold'>Agriculture Products</h1>
                ...
                <div className='bg-[#ffffff] px-4 py-4 rounded-lg basis-[30%]'>
                    ...
                    <h1 className='font-bold'>Daily Products</h1>
            ...
            <div className='bg-[#ffffff] px-4 py-4 rounded-lg basis-[30%]'>
                    ...
                    <h1 className='font-bold'>Access To A Wide Range Of Verified Suppliers.</h1>
            ...
            <div className='flex flex-col md:flex-row gap-5 justify-center items-center mt-10'>
                <div className='bg-[#ffffff] px-4 py-4 rounded-lg basis-[30%]'>
                    ...
                    <h1 className='font-bold'>Fresh Tomatoes</h1>
                    <p className='mt-3'>Discover a wide variety of fresh, seasonal produce directly from trusted suppliers</p>
                ...
                <div className='bg-[#ffffff] px-4 py-4 rounded-lg basis-[30%]'>
                    ...
                    <h1 className='font-bold'>Fresh Vegetables</h1>
                    <p className='mt-3'>Avoid hidden costs and eliminate the unfair influence of middlemen entirely</p>
